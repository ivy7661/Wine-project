<template>
  <div class="container">
    <div class="row justify-content-center">
      <h2 class="col-10 text-primary text-start my-4 policy-title">隱私權政策</h2>
    </div>

    <div class="row justify-content-center">
      <div class="bg-accent-brown rounded col-10">
        <div class="px-4 py-5">
          <p class="text-start">
            非常歡迎您光臨「Vin
            Chateau」(以下簡稱本網站)，為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
          </p>

            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
                  ...
                  <input id="image" v-model="editProduct.image" type="text" class="form-control mb-2"
                    placeholder="請輸入圖片名稱" />
                  <div v-if="editProduct.image">
                    <img class="img-fluid" :src="$filters.imgPath(`/images/wine_images/${editProduct.image}.jpg`)"
                      alt="product image" />
                  </div>
                </div>
              </div>
              <div class="col-sm-8">
                <div class="mb-3">
                  <label for="title" class="form-label">商品名稱
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col-md-4">
                    ...
                    <input id="place" v-model="editProduct.place" type="text" class="form-control"
                      placeholder="請輸入產區" />
                  </div>
                  <div class="mb-3 col-md-4">
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="village" v-model="editProduct.village" type="text" class="form-control"
                      placeholder="請輸入酒莊" />
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="grape" class="form-label">葡萄品種</label>
                    <input id="grape" v-model="editProduct.grape" class="form-control" placeholder="請輸入葡萄品種" />
                  </div>
                </div>
                <hr />
                <div class="row">
                  <div class="mb-3 col-md-4">
                    ...
                    <input id="flavor" v-model="editProduct.flavor" type="text" class="form-control"
                      placeholder="請輸入風味" />
                  </div>
                  <div class="mb-3 col-md-8">
                    <label for="food" class="form-label">搭餐</label>
                    <input id="food" v-model="editProduct.food" type="text" class="form-control" placeholder="請輸入搭餐" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3">
                    <label for="tannin" class="form-label">單寧</label>
                    <input id="tannin" v-model="editProduct.taste['tannin']" type="text" class="form-control"
                      placeholder="請輸入單寧" />
                  </div>
                  <div class="col-md-3">
                    <label for="body" class="form-label">酒體</label>
                    <input id="body" v-model="editProduct.taste.body" type="text" class="form-control"
                      placeholder="請輸入酒體" />
                  </div>
                  <div class="col-md-3">
                    <label for="acidity" class="form-label">酸度</label>
                    <input id="acidity" v-model="editProduct.taste.acidity" class="form-control" placeholder="請輸入酸度" />
                  </div>
                  <div class="col-md-3">
                    <label for="sweet" class="form-label">甜度</label>
                    <input id="sweet" v-model="editProduct.taste.sweet" class="form-control" placeholder="請輸入甜度" />
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-3">
                    <label for="num" class="form-label">數量
                      <span class="text-danger">*</span>
                    </label>
                  ...
                  <div class="col-md-3 mt-5 mb-3">
                    <div class="form-check">
                      <input id="is_enabled" v-model="editProduct.is_hot" class="form-check-input" type="checkbox"
